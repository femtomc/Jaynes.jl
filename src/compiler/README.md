This is a set of compile-time (and, occasionally, runtime) tools for specialization, type checking, etc. There is not a main `compile` entry point - instead these tools are used in a variety of places.
